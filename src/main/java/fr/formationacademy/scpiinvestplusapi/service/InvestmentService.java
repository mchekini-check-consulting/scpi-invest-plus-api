...
import fr.formationacademy.scpiinvestplusapi.dto.InvestmentKafkaDto;
...
public class InvestmentService {
    ...
    public InvestmentDto saveInvestment(InvestmentDto investmentDto) throws GlobalException {
        ...
        log.info("Investment avant sauvegarde : {}", investment);
        ...
        kafkaDto.setInvestmentDto(investmentMapper.toDTO(savedInvestment));
